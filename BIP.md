...
Where two participants wish to redact the same content, redacted data can be shared between nodes, in redacted form; for example, as part of an initial block download.
...
Most Bitcoin users are okay with this, because the benefits greatly outweigh the costs. People don't generally want to maximise the amount of arbitrary data they are holding on their nodes at other people's request, but (as of 2025) this is the only way to run a node. Take it or leave it.
